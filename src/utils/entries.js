...
import { render } from 'svelte/server'; // Import the render function
...
const getMetadata = (entryType, filepath, entry) => {
    const { html } = render(entry.default, {}); // Use the render function instead
    ...
    return {
        ...
        content: html, // Use the rendered HTML from the entry
